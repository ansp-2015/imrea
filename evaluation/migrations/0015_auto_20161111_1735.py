...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('evaluation', '0014_bostonaphasiamechanicswriting_bostonaphasiaoralspelling_bostonaphasiareadingsentences_bostonaphasias'),
    ]

    operations = [
        migrations.CreateModel(
            name='BostonAphasiaCopyPangramPhrase',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('copy_pangram_phrase_score', models.IntegerField(null=True, verbose_name='Copy score', blank=True)),
                ('bostonAphasia', models.OneToOneField(to='evaluation.BostonAphasia')),
            ],
        ),
        migrations.CreateModel(
            name='BostonAphasiaDictatedWords',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('dictated_words_letters_score', models.IntegerField(null=True, verbose_name='Dictated letters (B - K - L - R - T)', blank=True)),
                ('dictated_words_numbers_score', models.IntegerField(null=True, verbose_name='Dictated numbers (7 - 15 - 42 - 193 - 1865)', blank=True)),
                ('dictated_words_words_score', models.IntegerField(null=True, verbose_name='Dictated words (go - boy - run - come - baby)', blank=True)),
                ('bostonAphasia', models.OneToOneField(to='evaluation.BostonAphasia')),
            ],
        ),
        migrations.CreateModel(
            name='BostonAphasiaNarrativeWriting',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('narrative_writing_score', models.IntegerField(null=True, verbose_name='Total', blank=True)),
                ('bostonAphasia', models.OneToOneField(to='evaluation.BostonAphasia')),
            ],
        ),
        migrations.CreateModel(
            name='BostonAphasiaRecallWrittenSymbols',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('serial_writing_letters_score', models.IntegerField(null=True, verbose_name='Qualification level of writing mechanics:', blank=True)),
                ('serial_writing_numbers_score', models.IntegerField(null=True, blank=True)),
                ('bostonAphasia', models.OneToOneField(to='evaluation.BostonAphasia')),
            ],
        ),
        migrations.CreateModel(
            name='BostonAphasiaSentecesWrittenDictation',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('sentences_written_dictation_a_score', models.IntegerField(null=True, verbose_name='She can not see him.', blank=True)),
                ('sentences_written_dictation_a_exchanges', models.IntegerField(null=True, blank=True)),
                ('sentences_written_dictation_b_score', models.IntegerField(null=True, verbose_name='The boy is stealing cookies', blank=True)),
                ('sentences_written_dictation_b_exchanges', models.IntegerField(null=True, blank=True)),
                ('sentences_written_dictation_c_score', models.IntegerField(null=True, verbose_name='If he is not careful the stool will fall', blank=True)),
                ('sentences_written_dictation_c_exchanges', models.IntegerField(null=True, blank=True)),
                ('bostonAphasia', models.OneToOneField(to='evaluation.BostonAphasia')),
            ],
        ),
        migrations.CreateModel(
            name='BostonAphasiaSpellingDictation',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('spelling_dictation_a_score', models.IntegerField(null=True, verbose_name='soft', blank=True)),
                ('spelling_dictation_a_answer', models.CharField(max_length=100, null=True, blank=True)),
                ('spelling_dictation_b_score', models.IntegerField(null=True, verbose_name='own', blank=True)),
                ('spelling_dictation_b_answer', models.CharField(max_length=100, null=True, blank=True)),
                ('spelling_dictation_c_score', models.IntegerField(null=True, verbose_name='soap', blank=True)),
                ('spelling_dictation_c_answer', models.CharField(max_length=100, null=True, blank=True)),
                ('spelling_dictation_d_score', models.IntegerField(null=True, verbose_name='fight', blank=True)),
                ('spelling_dictation_d_answer', models.CharField(max_length=100, null=True, blank=True)),
                ('spelling_dictation_e_score', models.IntegerField(null=True, verbose_name='uncle', blank=True)),
                ('spelling_dictation_e_answer', models.CharField(max_length=100, null=True, blank=True)),
                ('spelling_dictation_f_score', models.IntegerField(null=True, verbose_name='freedom', blank=True)),
                ('spelling_dictation_f_answer', models.CharField(max_length=100, null=True, blank=True)),
                ('spelling_dictation_g_score', models.IntegerField(null=True, verbose_name='theater', blank=True)),
                ('spelling_dictation_g_answer', models.CharField(max_length=100, null=True, blank=True)),
                ('spelling_dictation_h_score', models.IntegerField(null=True, verbose_name='private', blank=True)),
                ('spelling_dictation_h_answer', models.CharField(max_length=100, null=True, blank=True)),
                ('spelling_dictation_i_score', models.IntegerField(null=True, verbose_name='physician', blank=True)),
                ('spelling_dictation_i_answer', models.CharField(max_length=100, null=True, blank=True)),
                ('spelling_dictation_j_score', models.IntegerField(null=True, verbose_name='awareness', blank=True)),
                ('spelling_dictation_j_answer', models.CharField(max_length=100, null=True, blank=True)),
                ('bostonAphasia', models.OneToOneField(to='evaluation.BostonAphasia')),
            ],
        ),
        migrations.CreateModel(
            name='BostonAphasiaWrittenPictureNaming',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('written_picture_naming_a_score', models.IntegerField(null=True, verbose_name='key', blank=True)),
                ('written_picture_naming_b_score', models.IntegerField(null=True, verbose_name='chair', blank=True)),
                ('written_picture_naming_c_score', models.IntegerField(null=True, verbose_name='circle', blank=True)),
                ('written_picture_naming_d_score', models.IntegerField(null=True, verbose_name='square', blank=True)),
                ('written_picture_naming_e_score', models.IntegerField(null=True, verbose_name='fifteen', blank=True)),
                ('written_picture_naming_f_score', models.IntegerField(null=True, verbose_name='seven', blank=True)),
                ('written_picture_naming_g_score', models.IntegerField(null=True, verbose_name='brown', blank=True)),
                ('written_picture_naming_h_score', models.IntegerField(null=True, verbose_name='red', blank=True)),
                ('written_picture_naming_i_score', models.IntegerField(null=True, verbose_name='drinking', blank=True)),
                ('written_picture_naming_j_score', models.IntegerField(null=True, verbose_name='smoking', blank=True)),
                ('bostonAphasia', models.OneToOneField(to='evaluation.BostonAphasia')),
            ],
        ),
        ...
        migrations.AlterModelOptions(
            name='vonfrey',
            options={'verbose_name': 'Von Frey - Algometer', 'verbose_name_plural': 'Von Frey - Algometer'},
        ),
        migrations.AlterField(
            model_name='bostonaphasiamechanicswriting',
            name='mechanics_writing_score',
            field=models.IntegerField(null=True, verbose_name='Qualification level of writing mechanics:', blank=True),
        ),
        migrations.AlterField(
            model_name='bostonaphasiaoralsentencereading',
            name='sentence_reading_g_score',
            field=models.IntegerField(null=True, verbose_name='The spy fled to Greece.', blank=True),
        ),
        migrations.AlterField(
            model_name='bostonaphasiaoralsentencereading',
            name='sentence_reading_h_score',
            field=models.IntegerField(null=True, verbose_name='The barm swallow captured a plump worm.', blank=True),
        ),
        migrations.AlterField(
            model_name='bostonaphasiaoralsentencereading',
            name='sentence_reading_i_score',
            field=models.IntegerField(null=True, verbose_name="The lawyer's closing argument convinced him.", blank=True),
        ),
        migrations.AlterField(
            model_name='bostonaphasiaoralsentencereading',
            name='sentence_reading_j_score',
            field=models.IntegerField(null=True, verbose_name='The phantom soared across the foggy heath.', blank=True),
        ),
        migrations.AlterField(
