    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orientation_day_week', models.IntegerField(verbose_name='Dia da semana (1 ponto)', choices=[(0, b'0'), (1, b'1')])),
                ('orientation_day_month', models.IntegerField(verbose_name='Dia do m\xeas (1 ponto)', choices=[(0, b'0'), (1, b'1')])),
                ('orientation_month', models.IntegerField(verbose_name='M\xeas (1 ponto)', choices=[(0, b'0'), (1, b'1')])),
                ('orientation_year', models.IntegerField(verbose_name='Ano (1 ponto)', choices=[(0, b'0'), (1, b'1')])),
                ('orientation_time', models.IntegerField(verbose_name='Hora aproximada (1 ponto)', choices=[(0, b'0'), (1, b'1')])),
                ('orientation_place', models.IntegerField(verbose_name='Local espec\xedfico (aposento ou setor) (1 ponto)', choices=[(0, b'0'), (1, b'1')])),
                ('orientation_institution', models.IntegerField(verbose_name='Institui\xe7\xe3o (resid\xeancia, hospital, cl\xednica) (1 ponto)', choices=[(0, b'0'), (1, b'1')])),
                ('orientation_district', models.IntegerField(verbose_name='Bairro ou rua pr\xf3xima (1 ponto)', choices=[(0, b'0'), (1, b'1')])),
                ('orientation_city', models.IntegerField(verbose_name='Cidade (1 ponto)', choices=[(0, b'0'), (1, b'1')])),
                ('orientation_state', models.IntegerField(verbose_name='Estado (1 ponto)', choices=[(0, b'0'), (1, b'1')])),
                ('registration_words', models.IntegerField(help_text='Name 3 objects: 1 second to say each. Then ask the patient all 3 after you have said them. Give 1 point for each correct answer.Then repeat them until he/she learns all 3. Count trials and record', verbose_name='Mem\xf3ria imediata', choices=[(0, b'0'), (1, b'1'), (2, b'2'), (3, b'3')])),
                ('attention_calc', models.IntegerField(help_text='Subtrair 100-7, 7 vezes sucessivamente ( ponto para cada c\xe1lculo correto)<br>Alternativamente, soletra MUNDO de tr\xe1s para frente.', verbose_name='Aten\xe7\xe3o e c\xe1lculo', choices=[(0, b'0'), (1, b'1'), (2, b'2'), (3, b'3'), (4, b'4'), (5, b'5')])),
                ('recall_words', models.IntegerField(help_text='Pergunte pelas 3 palavras ditas anteriormente (1 ponto por palavra)', verbose_name='Evoca\xe7\xe3o', choices=[(0, b'0'), (1, b'1'), (2, b'2'), (3, b'3')])),
                ('language_watch_pen', models.IntegerField(verbose_name='Nomear um rel\xf3gio e uma caneta (2 pontos)', choices=[(0, b'0'), (1, b'1'), (2, b'2')])),
                ('language_repeat', models.IntegerField(verbose_name="Repetir 'nem aqui, nem ali, nem l\xe1' (1 ponto)", choices=[(0, b'0'), (1, b'1')])),
                ('language_command', models.IntegerField(verbose_name="Comando: 'pegue este papel com a m\xe3o direita dobre ao meio e coloque no ch\xe3o' (3 pontos)", choices=[(0, b'0'), (1, b'1'), (2, b'2'), (3, b'3')])),
                ('language_read', models.IntegerField(verbose_name="Ler e obedecer 'feche os olhos' (1 ponto)", choices=[(0, b'0'), (1, b'1')])),
                ('language_write', models.IntegerField(verbose_name='Escrever uma frase (1 ponto)', choices=[(0, b'0'), (1, b'1')])),
                ('language_copy', models.IntegerField(verbose_name='Copiar um desenho (1 ponto)', choices=[(0, b'0'), (1, b'1')])),
        ...
        migrations.AlterField(
            model_name='sis',
            name='scale_recovery',
            field=models.IntegerField(verbose_name='Stroke Recovery scale'),
        ),
        migrations.AlterField(
            model_name='sis',
            name='strength_arm',
