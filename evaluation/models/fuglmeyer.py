...
class FuglMeyer(BaseEvaluation):
    ...
    ue_hand_thumb_adduction = models.IntegerField(_(u'Thumb adduction'),
                                                  ...
                                                  help_text=_(u'Ask the patient to perform pure thumb adduction with the scrap of paper interposed between the thumb and '
                                                              'first digit. Test this grip against resistance by asking the patient to hold as you attempt to pull the paper out '
                                                              'with a slight tug. <strong>Hold the paper between the thumb and forefinger</strong>'))
    # opposition
    ...
    ue_hand_thumb_opposition = models.IntegerField(_(u'Opposition pulpa of the thumb against the pulpa of 2-nd finger,pencil, tug upward'),
                                                   ...
                                                   help_text=_(u'Subject is sitting with arm on bedside table. Instruct the patient to grasp a pen by opposing the thumb and index '
                                                               u'finger pads around the pen. The pen may not be stabilized by the therapist or the patient’s other hand. '
                                                               u'Test this grip against resistance by asking the patient to hold as you attempt to pull the pencil out '
                                                               u'with a slight tug. <strong>Hold the pen and keep it steady</strong>'))
    # cylinder grip
    ...
    ue_hand_cylinder_grip = models.IntegerField(_(u'Cylinder shaped object (small can)tug upward, opposition in digits I and II'),
                                                ...
                                                help_text=_(u'Subject is sitting with arm on bedside table. '
                                                            u'Instruct the patient to grasp a small can (placed upright on a table without stabilization) by '
                                                            u'opening the fingers and opposing the volar surfaces of the thumb and digits. The arm may be supported but '
                                                            u'the tester may not assist with hand function. Test this grip against resistance by asking the patient to hold '
                                                            u'as you attempt to pull the can out with a slight tug.<strong>Hold the object and keep it steady</strong>'))
    # spherical grip
    ...
    ue_hand_spherical_grip = models.IntegerField(_(u'Fingers in abduction/flexion, thumb opposed, tennis ball'),
                                                 ...
                                                 help_text=_(u'Subject is sitting with arm on bedside table. '
                                                             u'Instruct the patient to perform a spherical grasp by grasping a tennis ball. '
                                                             u'The tester may support the patient’s arm but may not assist with the hand function required for the retrieval task. '
                                                             u'Test this grip against resistance by asking the patient to hold as you attempt to pull the ball out with a slight '
                                                             u'tug. <strong>Hold the ball and keep it steady</strong>'))
