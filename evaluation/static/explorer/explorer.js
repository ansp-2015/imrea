...
ExplorerEditor.prototype.showSchema = function() {
    ...
    $("#query_area").removeClass("col-md-12").addClass("col-md-8");
    var schema$ = $("#schema");
    schema$.addClass("col-md-4");
    schema$.show();
    $(this).hide();
...
ExplorerEditor.prototype.hideSchema = function() {
    $("#query_area").removeClass("col-md-8").addClass("col-md-12");
    var schema$ = $("#schema");
    schema$.removeClass("col-md-4");
    schema$.hide();
    $(this).hide();
