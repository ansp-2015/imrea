var reportBuilder = angular.module('reportBuilder', ['ngRoute', 'restangular', 'ngMaterial', 'ui.tree', 'ngHandsontable', 'angularPikaday', 'pascalprecht.translate']);
...
// Traducao
reportBuilder.config(function ($translateProvider) {
  $translateProvider.useStaticFilesLoader({
	    prefix: '/static/report_builder/languages/',
	    suffix: '.json'
	  });
  /*
